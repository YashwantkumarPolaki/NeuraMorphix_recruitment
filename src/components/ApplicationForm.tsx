        ...
        <div className="glass-panel p-8 rounded-2xl text-center space-y-6 animate-fadeIn">
          ...
          <div className="p-6 rounded-2xl bg-slate-950/90 border border-cyan-500/40 max-w-xl mx-auto text-left space-y-3 shadow-xl">
            ...
            <div className="text-xs text-slate-300 space-y-1">
              <div><strong className="text-slate-400">To:</strong> {submittedApplicant.email}</div>
              <div><strong className="text-slate-400">Subject:</strong> Neuramorphix Recruitment — Application Received</div>
            </div>
...
First Preference: ${submittedApplicant.first_preference}

Second Preference: ${submittedApplicant.second_preference}
